              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    className="w-full bg-[rgb(var(--color-page))]/50 border border-[rgb(var(--color-txt-muted))]/20 rounded-lg pl-12 pr-4 py-3 text-[rgb(var(--color-txt-main))] placeholder-[rgb(var(--color-txt-dim))] focus:border-brand-purple/50 focus:outline-none transition-all"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    required
                    className="w-full bg-[rgb(var(--color-page))]/50 border border-[rgb(var(--color-txt-muted))]/20 rounded-lg pl-12 pr-4 py-3 text-[rgb(var(--color-txt-main))] placeholder-[rgb(var(--color-txt-dim))] focus:border-brand-blue/50 focus:outline-none transition-all"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    required
                    className="w-full bg-white/5 border border-[rgb(var(--color-txt-muted))]/20 rounded-lg pl-10 pr-2 py-3 text-[rgb(var(--color-txt-main))] focus:border-brand-purple/50 transition-all [color-scheme:dark]"
                  />
                </div>
              </div>
